...
-- Changeset dbF360Mysql_3.0.0.xml::f360Mysql_3.0.0::hp::(Checksum: 3:f26bc3c0cfc26c2bae7c4583fe3da18b)
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Custom SQL (x2)', 'EXECUTED', 'dbF360Mysql_3.0.0.xml', 'f360Mysql_3.0.0', '2.0.1', '3:f26bc3c0cfc26c2bae7c4583fe3da18b', 13);
...
-- Changeset dbF360_18.10.xml::f360_18.10_01::hp::(Checksum: 3:951113fc9ecf66439ef55431c7ad3ecd)
CREATE TABLE `projectversionviewoption` (`projectVersion_id` BIGINT NOT NULL, `userName` VARCHAR(255) NOT NULL, `optionName` VARCHAR(40) NOT NULL, `boolValue` VARCHAR(1), CONSTRAINT `PK_PROJECTVERSIONVIEWOPTION` PRIMARY KEY (`projectVersion_id`, `userName`, `optionName`));

INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Create Table', 'EXECUTED', 'dbF360_18.10.xml', 'f360_18.10_01', '2.0.1', '3:951113fc9ecf66439ef55431c7ad3ecd', 321);

-- Changeset dbF360_18.10.xml::f360_18.10_02::hp::(Checksum: 3:727b559c7cf54c909b519b5784390a46)
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Create Index (x2)', 'EXECUTED', 'dbF360_18.10.xml', 'f360_18.10_02', '2.0.1', '3:727b559c7cf54c909b519b5784390a46', 322);

-- Changeset dbF360_18.10.xml::f360_18.10_03::hp::(Checksum: 3:c98963b5b656952e2d7321927b44bbbd)
ALTER TABLE `agentcredential` ADD `description` VARCHAR(255);

ALTER TABLE `agentcredential` ADD `type` VARCHAR(255);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Add Column, Drop Index, Create Index (x3)', 'EXECUTED', 'dbF360_18.10.xml', 'f360_18.10_03', '2.0.1', '3:c98963b5b656952e2d7321927b44bbbd', 323);

-- Changeset dbF360_18.10.xml::f360_18.10_04::hp::(Checksum: 3:7d8dc6c75934955ddd0bcce9a652e867)
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Update Data (x3)', 'EXECUTED', 'dbF360_18.10.xml', 'f360_18.10_04', '2.0.1', '3:7d8dc6c75934955ddd0bcce9a652e867', 324);

-- Changeset dbF360_18.10.xml::f360_18.10_05::hp::(Checksum: 3:b00a0460eda0397c94d512f3e3f07377)
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Custom SQL', 'EXECUTED', 'dbF360_18.10.xml', 'f360_18.10_05', '2.0.1', '3:b00a0460eda0397c94d512f3e3f07377', 325);

-- Changeset dbF360_18.10.xml::f360_18.10_06::hp::(Checksum: 3:ce9ab3ef107db771a54c198bba014263)
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Create Table, Create Index, Add Foreign Key Constraint (x4)', 'EXECUTED', 'dbF360_18.10.xml', 'f360_18.10_06', '2.0.1', '3:ce9ab3ef107db771a54c198bba014263', 326);

-- Changeset dbF360_18.10.xml::f360_18.10_07::hp::(Checksum: 3:ea283d706b0889d63fe24578b551eea8)
-- valueChangeType field is added to mark auto applied values
ALTER TABLE `auditvalue` ADD `valueChangeType` VARCHAR(16);

INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', 'valueChangeType field is added to mark auto applied values', NOW(), 'Add Column', 'EXECUTED', 'dbF360_18.10.xml', 'f360_18.10_07', '2.0.1', '3:ea283d706b0889d63fe24578b551eea8', 327);

-- Changeset dbF360_18.10.xml::f360_18.10_08::hp::(Checksum: 3:887a7742820f9133f05e11912a5d52a7)
ALTER TABLE `projectversion` ADD `customTagValuesAutoApply` VARCHAR(1);

INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Add Column', 'EXECUTED', 'dbF360_18.10.xml', 'f360_18.10_08', '2.0.1', '3:887a7742820f9133f05e11912a5d52a7', 328);

-- Changeset dbF360_18.10.xml::f360_18.10_09_mxsql::hp::(Checksum: 3:7760f174362fb102149e7d7b5ba949fc)
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Drop Primary Key, Add Column, Create Index', 'EXECUTED', 'dbF360_18.10.xml', 'f360_18.10_09_mxsql', '2.0.1', '3:7760f174362fb102149e7d7b5ba949fc', 329);

-- Changeset dbF360_18.10.xml::f360_18.10_10::hp::(Checksum: 3:c5b0be6f1e82f571e5152efbb5e5a41e)
ALTER TABLE `analysisblob` ADD `checksum` VARCHAR(60);

INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Add Column', 'EXECUTED', 'dbF360_18.10.xml', 'f360_18.10_10', '2.0.1', '3:c5b0be6f1e82f571e5152efbb5e5a41e', 330);

-- Changeset dbF360_18.10.xml::f360_18.10_11::hp::(Checksum: 3:0d42fa9a25ce64988aca68b00d707385)
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Update Data', 'EXECUTED', 'dbF360_18.10.xml', 'f360_18.10_11', '2.0.1', '3:0d42fa9a25ce64988aca68b00d707385', 331);

-- Changeset dbF360_18.10.xml::f360_18.10_12::hp::(Checksum: 3:bcc2657373f03ce0a46969d7eac8dbf6)
DELETE FROM issuecache WHERE NOT EXISTS (SELECT issue.id FROM issue WHERE issuecache.issue_id = issue.id);

INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Custom SQL', 'EXECUTED', 'dbF360_18.10.xml', 'f360_18.10_12', '2.0.1', '3:bcc2657373f03ce0a46969d7eac8dbf6', 332);

-- Changeset dbF360_18.10.xml::f360_18.10_13::hp::(Checksum: 3:2559629d7b64865b5ec852ca19b31ff2)
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', 'remove bugfield templates of legacy jira4 and update templategroup description for supported jira.', NOW(), 'Delete Data, Update Data', 'EXECUTED', 'dbF360_18.10.xml', 'f360_18.10_13', '2.0.1', '3:2559629d7b64865b5ec852ca19b31ff2', 333);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Drop View, Create View', 'EXECUTED', 'views/dbF360_baseissueview.xml', 'baseissueview', '2.0.1', '3:013c957c3b1be591359d31a84e93e1d0', 334);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Drop View (x2), Create View (x2)', 'EXECUTED', 'views/dbF360_defaultissueview_standards.xml', 'defaultissueview_standards', '2.0.1', '3:b3cf3bd1c25b08027b80f9a90db7a3cd', 335);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Create View', 'EXECUTED', 'views/dbF360_measurementAgentInUseView.xml', 'measurementAgentInUseViewCreate', '2.0.1', '3:89b253a9112d08670456f8e6225cef53', 336);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Create View', 'EXECUTED', 'views/dbF360_variableInUseView.xml', 'variableInUseViewCreate', '2.0.1', '3:1456e7bfdf552fe95554d4b5ac7198e2', 337);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Drop View, Create View', 'EXECUTED', 'views/dbF360_metadefview.xml', 'metadefview', '2.0.1', '3:a428f4eb64aa27313b7523720a5ba16b', 338);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Create View', 'EXECUTED', 'views/dbF360_externalcatorderview.xml', 'externalcatorderview', '2.0.1', '3:a8cf4a477b0121c7a40c575e2576f998', 339);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Drop View, Create View', 'EXECUTED', 'views/dbF360_auditvalueview.xml', 'auditvalueview', '2.0.1', '3:85dc5004a8e302f1c42a8cfddce0c96a', 340);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Create View', 'EXECUTED', 'views/dbF360_attrLookupInUseView.xml', 'attrLookupInUseView_mysql', '2.0.1', '3:b0086dbfbf8426bda5005741a2866b07', 341);

-- Changeset views/dbF360_scanissueview.xml::scanissueview::hp::(Checksum: 3:0a19ade359a880bed6d73dff76333cd7)
DROP VIEW `scanissueview`;

CREATE VIEW `scanissueview` AS SELECT si.projectVersion_id, si.scan_id, si.id, si.issue_id, si.issueInstanceId,
            s.startDate, s.engineType
            FROM scan_issue si INNER JOIN scan s ON si.scan_id = s.id;

INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Drop View, Create View', 'EXECUTED', 'views/dbF360_scanissueview.xml', 'scanissueview', '2.0.1', '3:0a19ade359a880bed6d73dff76333cd7', 342);

-- Changeset procs/dbF360_updateScanIssueIds.xml::updateScanIssueIds_mysql::hp_main::(Checksum: 3:f1aae6ffebfc6699f47aa54a77430d5d)
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp_main', '', NOW(), 'Custom SQL (x2)', 'EXECUTED', 'procs/dbF360_updateScanIssueIds.xml', 'updateScanIssueIds_mysql', '2.0.1', '3:f1aae6ffebfc6699f47aa54a77430d5d', 343);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp_main', '', NOW(), 'Custom SQL (x2)', 'EXECUTED', 'procs/dbF360_updateIssuesFromFilterSet.xml', 'updateIssuesFromFilterSet_mysql', '2.0.1', '3:895219144944570a661cad4a152175ca', 344);

-- Changeset procs/dbF360_updateExistingWithLatest.xml::updateExistingWithLatest_mysql::hp_main::(Checksum: 3:9927739c1affac2bccb631f744738cbf)
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp_main', '', NOW(), 'Custom SQL (x2)', 'EXECUTED', 'procs/dbF360_updateExistingWithLatest.xml', 'updateExistingWithLatest_mysql', '2.0.1', '3:9927739c1affac2bccb631f744738cbf', 345);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Custom SQL (x2)', 'EXECUTED', 'procs/dbF360_updateDeletedIssues.xml', 'updateDeletedIssues_mysql', '2.0.1', '3:950c9661a45955b00676b087a0d9440c', 346);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Custom SQL (x2)', 'EXECUTED', 'procs/dbF360_updateRemovedWithUpload.xml', 'updateRemovedWithUpload_mysql', '2.0.1', '3:7c3bf7d707649215c2c10b786a7eb003', 347);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp', '', NOW(), 'Custom SQL (x2)', 'EXECUTED', 'procs/dbF360_updateRemovedWithUpload2nd.xml', 'updateRemovedWithUpload2nd_mysql', '2.0.1', '3:c3522de2765086c8222c505c91a9690f', 348);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp_main', '', NOW(), 'Custom SQL (x2)', 'EXECUTED', 'procs/dbF360_migrateScanIssueIds.xml', 'migrateScanIssueIds_mysql', '2.0.1', '3:c3097e7b3c4529f6836dbd139978e0a2', 349);
...
INSERT INTO `DATABASECHANGELOG` (`AUTHOR`, `COMMENTS`, `DATEEXECUTED`, `DESCRIPTION`, `EXECTYPE`, `FILENAME`, `ID`, `LIQUIBASE`, `MD5SUM`, `ORDEREXECUTED`) VALUES ('hp_main', '', NOW(), 'Custom SQL (x2)', 'EXECUTED', 'procs/dbF360_extractFileName.xml', 'extractFileName_mysql', '2.0.1', '3:a273d6b66a857e20de8f13ac2e50b48d', 350);
